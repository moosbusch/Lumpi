 ...
 * @author moosbusch
 */
public interface OSGiApplication extends DesktopApplication {
    ...
    public static abstract class Adapter extends DesktopApplication.Adapter implements OSGiApplication {
